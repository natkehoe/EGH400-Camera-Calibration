function WorldTransformations(savematfile, camExtrinsics, optiMarker)
% WORLDTRANSFORMATIONS
% Calculates the world transformations for origin, camera, checkerboard 
% and optitracking marker.
% 
% INPUTS:
%   - 'savematfile' - filename that will load outputs to Main.m
%   - 'camExtrinsics' - extrinsic camera parameters and transformations -
%       used to determine marker2camera transforms
%   - 'optiMarker' - optitracking raw data
% 
% OUTPUTS:
%   - 'origin' translation and rotation matrices
%   - 'cam_est' translation and rotation matrices
%   - 'camCheckerboard' translation and rotation matrices
%   - 'check2world' translation and rotation matrices
%   - 'optiMarker' translation and rotation matrices
% 
...
marker2camera = camExtrinsics.marker2camera;

% %% Calculate translation and rotations <-- WRONG
...
% camCheckerboard_t = [marker2camera.x, marker2camera.y, marker2camera.z]'; % [mm]
camCheckerboard_t = camExtrinsics.t';
camCheckerboard_R = camExtrinsics.R;

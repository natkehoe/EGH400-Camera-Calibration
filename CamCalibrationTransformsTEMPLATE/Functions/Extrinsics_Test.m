function output = extrinsics_test(calibrationData, imageFileName)
%% ! RUN VIA MAIN.M
...
squareSize = calibrationData.calibrationSession.PatternSet.SquareSize;  % Set the size of a square in the checkerboard (in millimeters)
...
%% Save data
% save(saveFileName, 'calibrationData', 'imageFileName', 'marker');
output = struct;
output.calibrationData = calibrationData;
